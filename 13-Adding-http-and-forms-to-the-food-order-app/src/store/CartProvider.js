...
const cartReducer = (state, action) => {
  ...
  // if the action type is CLEAR, we need to clear the cart
  if (action.type === "CLEAR") {
    return defaultCartState; // we are returning the initial state of the cart
    // although is not a good practice, we are mutating the state here for simplicity purposes
  }
